...
public:
    ...
    void getColor(unsigned char* toFill, fixed_t* am, fixed_t* op, fixed_t* ref, fixed_t x,
                  fixed_t y);
    void getColor(unsigned char* toFill, fixed_t* am, fixed_t* op, fixed_t* ref, unsigned int x,
                  unsigned int y);
